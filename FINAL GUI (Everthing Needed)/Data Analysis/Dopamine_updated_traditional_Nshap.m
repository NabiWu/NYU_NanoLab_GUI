...
dataFolderPath='/Users/Victor/Desktop/2019 NanoLab/MATLAB/FSCV code/FSCV Analysis/FSCV_V18';
%File_name_I ='CM_N5A_9_C3260319_190906200nA_vern100p_1uM_400Vs_10Hz_ne_0p4_to_1p3_V2.tdms';
fileName_I = 'CM_N7A_82_DA_1_200_10_ne0p2_po0p6_120320_120721_ch1Vol.txt';
fileName_V = 'CM_N7A_82_DA_1_200_10_ne0p2_po0p6_120320_120721_ch2Vol.txt';
cd (dataFolderPath)
...
First_cycle_PBS=90;  %first background cycle for current subtraction 
N_cycle_PBS=50;

First_cycle_DA=500;  %first DA cycle for current subtraction
N_cycle_DA=40;
...
for j=1:1:NumOfCycle_DA-1    
    ...
    Index_background= find (Voltage_single_cycle>0.53 & Voltage_single_cycle_DA<0.54);
    ...
    Background_current=Current_single_cycle(Index_background);
   ...
   Peak_current_r2=max(Subtracted_current_local_r2);
    ...
    Background_current_matrix=[Background_current_matrix;Background_current'];
