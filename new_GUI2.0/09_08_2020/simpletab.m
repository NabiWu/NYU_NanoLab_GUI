...
handles.t2=text('String','In-Vitro',...
                'Units','normalized',...
...
handles.t3=text('String','In-Vivo',...
                'Units','normalized',...
...
handles.a4=axes('Units','normalized',...
                ...
                'ButtonDownFcn','simpletab(''a4bd'',gcbo,[],guidata(gcbo))');
handles.t4=text('String','Analysis',...
                'Units','normalized',...
                ...
                'FontSize',8,...
                'Backgroundcolor',handles.unselectedTabColor,...
                'ButtonDownFcn','simpletab(''t4bd'',gcbo,[],guidata(gcbo))');            
...
% --- Executes on button press in tab4button.
function tab4button_Callback(hObject, eventdata, handles)
disp('Button from Tab 4 was pressed')
