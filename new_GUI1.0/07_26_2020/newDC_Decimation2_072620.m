...
%Create three cases for plotting choice 
switch pcstr
    
    %This case have three plotting mode: V-I, V-t, I-t. We use V-I to do
    %data analysis
    case 'Realtime V vs I'
        %Get our initials from edit boxes
        ...
        %RfeedBacks are initialized by confirm configuration button
        ...
        %Create empty arrays storing data for plotting 
        handles.data_L1=[];
        handles.data_R1=[];
        handles.current_L1=[];
        handles.current_R1=[];
        ...
        %Create empty arrays storing data for saving and writting in file
        ...
        %Create empty arrays collecting original data from 4 channels
        ...
        %Initialize the temp data created and appended cycle by cycle
        ...
        %Create empty array used for FSCV Plotting
        data_cycle_L1=[];
        data_cycle_R1=[];
        data_cycle_L2=[];
        data_cycle_R2=[];        
        ...
        %Regular set and update the okFrontPanel Library
        ...
        for i= 1:cycle
            ...
            %Update the isSave and isStop value for each cycle
