...
Datafolder='C:\Users\kae-d\Desktop\OSR256_USB3_Bohan(2CH)\CM_N5A_64C2C6_V9';
...
fileID=fopen('CM_N5A_64_C2C6_DA_2_200_10_ne0p2_po0p6_161219_141005_ch4Vol.txt','r');  % aquired data from ADC
A=fscanf(fileID,'%f\n');
fclose(fileID);
...
[Peak1, Peak_index1]=findpeaks(data_3, 'MinPeakHeight', 0.5, 'MinPeakDistance',round(1/FSCV_frequency*sampling_rate_ADC)-10);
