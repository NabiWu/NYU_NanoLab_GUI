...
% Last Modified by GUIDE v2.5 10-Feb-2020 22:39:57
...
% --- Executes on button press in dataAnalysisCH3.
function dataAnalysisCH3_Callback(hObject, eventdata, handles)
        ...
        for i=[1:(NOCycle)]
        % Peak_index1(i)=((219)+1000*(i-1));  %the index represents the starting point of each cycle
...
% --- Executes on button press in dataAnalysisCH4.
function dataAnalysisCH4_Callback(hObject, eventdata, handles)
         %% Define folder path and file name
        ...
        fileID=fopen(ch4DataFileName ,'r');  % aquired data from ADC
        B=fscanf(fileID,'%f\n');
        fclose(fileID);
